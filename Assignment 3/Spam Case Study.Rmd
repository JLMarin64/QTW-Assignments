...
```
```{r code4, echo = TRUE , include = TRUE}
...
tail(msg)
```
```{r code5, echo=TRUE, include=TRUE}
...
```{r code6, echo=TRUE, include="TRUE"}
...
```{r code7, echo=TRUE, include=TRUE}
...
```
```{r code 8, echo=TRUE, include=TRUE}
computeFreqs =
...
```{r code9, echo=TRUE, include=TRUE}
typeIErrorRate = 
...
```{r code10, echo=TRUE, include=TRUE}
...
```{r rpart, echo=TRUE, include=TRUE}
#load(file="data.Rda")
...
```
```{r codefitgraph, echo=TRUE, include=TRUE}
...
```
```{r parms, echo=TRUE, include=TRUE}
